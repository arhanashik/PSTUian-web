<?php 
  ...
  if($user_id == null || $user_type == null) {
    echo 'Invalid Request! Authentication required!';
    exit(1);
  }
?>
<!DOCTYPE html>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="container" id="reset-container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-12">
                    <input type="submit" value="Delete Account" onclick="deleteAccount()" class="btn btn-primary py-3 px-5">
                </div>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
    function deleteAccount() {
      ...
      $.ajax({
          url: `${baseUrl}auth.php?call=deleteAccount`,
          type:'post',
          data: data,
