    ...
    <div class="row">
      <div class="col-lg-9">
        <div class="section-title">
          <span class="caption d-block small">Teachers</span>
        ...
        <div id="list-data">
          <!-- <div class="post-entry-2 d-flex" style="height:140px;">
            ...
            <div class="contents order-md-1 pl-0">
              <h2><a href="blog-single.html">Teacher Name</a></h2>
              <p class="mb-3">Teacher Details</p>
              <div class="post-meta">
                <span class="d-block">Assistance Professor<span class="mx-1">&bullet;</span>Mathematics</span>
